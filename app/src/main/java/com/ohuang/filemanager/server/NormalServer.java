 ...
 */
public abstract class NormalServer<T extends NormalServer.Builder> implements Server {
...
//                                .setSndBufSize(BUFFER)
    ...
    public abstract static class Builder<T extends Builder, S extends Server> {
